...
def do_login(banner_version):
    ...
    print(f'**********    致敬初代版本开发者： Avenshy & SSmJaE   **********')
    print(f'**********      当前版本--{banner_version}： v1.0.0      **********')
    print(f'**********   您所使用的版本由饭昱昶于2026.05.24更新   **********')
    print(f'**********      QQ官方群：无 || 感谢支持       **********')
    print(f'**********          欢迎报考中北大学            **********')
    print('****************************************************************\n')

    loginmode = input('请选择登录Welearn的方式: \n   1.账号密码登录\n   2.Cookie值登录\n\n请输入数字1或2: ')
...
def login_time():
    return do_login('welearn时长版')


def login_course():
    return do_login('welearn课程版')
...
if __name__ == '__main__':
    print('**********    致敬初代版本开发者： Avenshy & SSmJaE   **********')
    print('**********      当前版本--welearn一体版： v1.0.0      **********')
    print('**********   您所使用的版本由饭昱昶于2026.05.24更新   **********')
    print('**********      QQ官方群：无 || 感谢支持       **********')
    print('**********          欢迎报考中北大学            **********')
    print('****************************************************************\n')
